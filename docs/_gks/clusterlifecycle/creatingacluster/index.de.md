...
Einen Cluster in GKS anzulegen benötigt nur ein paar Klicks.
Doch bevor wir dies tun können, benötigen wir ein Projekt.

Wenn Sie noch kein Projekt erstellt haben, [erstellen Sie bitte zuerst ein Projekt](/gks/managingprojects/creatingaproject).
...
in GKS anzulegen. Wie dieses verwendet werden kann, steht auf den nächsten Seiten.
