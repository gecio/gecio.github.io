...
We can create a cluster in GKS with a couple of clicks.
Before we can do that, there needs to be a project.

So if you don't have a project yet, [create a project first](/gks/managingprojects/creatingaproject).
...
To allow GKS to request the required resources from OpenStack, we add our
...
* What is an GKS Cluster
* How to create an GKS Cluster

Congratulations! Now you know how to create a Kubernetes Cluster with GKS.
