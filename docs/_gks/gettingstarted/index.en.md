...
This guide describes how to create your first GKS project with a first Kubernetes
cluster, how to connect to that cluster and how to clean up all resources
afterwards.

## Create your first project

After logging into GKS for the very first time, we will see the following window.
...
To clean up the cluster we created, we need to click `Delete` in the GKS-dashboard:
![Step 3](delete_3.png)
