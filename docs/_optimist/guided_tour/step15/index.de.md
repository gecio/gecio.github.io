...
gespeichert wird, einfach mit dem OpenStackClienten wie in [Schritt 13: "Der strukturierte Weg zu einer Instanz (mit Stacks)"](/de/optimist/guided_tour/step13) beschrieben, gestartet werden.
